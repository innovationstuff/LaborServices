...
namespace LaborServices.Web.Controllers
{
    ...
    public class PaymentController : BaseController
    {
        ...
        [HttpGet]
        public JsonResult Getsignature(string str)
        {
            long sum = 0;
            sum = str.Length * 25;
            sum = sum * sum;
        ...
        public ActionResult Failure(string reason, string id)
        {
        ...
        public async Task<ActionResult> Status()
        {
            ...
            if (!string.IsNullOrEmpty(realCheckoutId))
            {
                ...
                transaction.TransactionType = (int)TransactionType.ServiceContractPerHour;
                transaction.TransactionTypeName = TransactionType.ServiceContractPerHour.ToString();
        ...
        public ActionResult ShopperResult(ContractViewModel newContract)
        {
            var currentUser = UserManager.FindById(User.Identity.GetUserId());
        ...
        public async Task<ActionResult> DalalShopperResult(string id)
        {
        ...
        public ActionResult UploadBankApproval()
        {
            return View();
        }
        ...
        public async Task<ActionResult> PaymentMethod(string id)
        {
            if (string.IsNullOrEmpty(id))
                return HttpNotFound();
